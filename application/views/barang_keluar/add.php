    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_stok">Catatan</label>
                    <div class="col-md-5">
                        <textarea rows="10" cols="30" class="form-control" name="catatan"></textarea>
                    </div>
                </div>
                <div class="row form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('keyup change', '#jumlah_keluar', function(event) {
            event.preventDefault();
            /* Act on the event */
              let stok = $('#stok').val();
              var data = stok - $(this).val();
             $('#total_stok').val(data)

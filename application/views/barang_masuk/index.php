            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $bm['nama']; ?></td>
                            <td>
                                <a href="<?= base_url('barangmasuk/detail/') . $bm['id_barang_masuk'] ?>" class="btn btn-info btn-circle btn-sm"><i class="fa fa-eye"></i></a>

                                <button onclick='printDiv();' href="#" type="button" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-print"></i></button>
